...
import { estatus_problem, problem, requeriment, response, table_show, User } from 'src/app/Admin/services/type';
...
export class ShowRequestSolverComponent implements OnInit {
  ...
  ActionDetail(fecha: string){
    ...
    data: [      
      ...
      {title: 'Nobre de Escargado(a) de sucursal:', data:this.dataShowProblem.nombre_empleado},      
